                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="content">
                                ...
                                <p><a href="${baseURL}/cancel-appointment?appointmentId=${appointmentId}">Cancel Appointment</a></p>
                                <p><a href="${baseURL}/reschedule-appointment?appointmentId=${appointmentId}">Reschedule Appointment</a></p>
                            </div>
                            <div class="footer">
